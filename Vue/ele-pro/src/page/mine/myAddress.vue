<template>
    <div
        class='myAddress flex_column fixed_full'
    >
        <Top
            nav_title='我的收货地址'
            topBG="true"
...
export default {
  ...
  methods: {
    ...
    getList() {
     ...
     onEdit(item, index) {
         this.$router.replace({path:'/addressCreate',query:{type:'edit',id:item.id}})
...
<style>
.van-address-item .van-icon:nth-child(1){display: none;}
.van-button__text {
  color: #fff;
}
</style>