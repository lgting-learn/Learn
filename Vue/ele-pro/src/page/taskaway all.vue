...
export default {
  ...
  methods: {
    ...
    broadcastCell() {
      ...
      // if (this.isFixed) {
      //   $("#taskaway .vue-waterfall-easy-container .vue-waterfall-easy-scroll").css(
      //     "top",
      //     "80px"
      //   );
      // }else{
    ...
    calWaterfallHei() {
      ...
      // $("#taskaway .vue-waterfall-easy-scroll").css("height", this.maxHeiDiv - 10);

      // console.log("maxHeiDiv====" + this.maxHeiDiv + "  " + allHeightDiv.length);
      // }
    },
  },
  created() {
