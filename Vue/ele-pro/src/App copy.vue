...
#app
  ...
  #content
    ...
    vue-waterfall-easy(ref="waterfall",:imgsArr="imgsArr",@scrollReachBottom="getData", @click="clickFn", @imgError="imgErrorFn",@pullDownMove="pullDownMove",@pullDownEnd="pullDownEnd")
